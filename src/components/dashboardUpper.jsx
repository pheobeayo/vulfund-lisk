...
const DashboardUpper = () => {
    return (
        ...
        <div className='lg:w-[60%] md:w-[60%] w-[100%] p-8'>
            ...
            <div className='mt-6'>
                <NavLink to='/dashboard/request_fund' className="bg-[#DA8450] text-white py-2 px-4 rounded-lg lg:text-[20px] md:text-[20px] font-bold text-[16px] w-[100%] lg:w-[50%] md:w-[50%] my-2 hover:bg-[#110A03] hover:font-bold">Request Fund</NavLink>
        ...
        <div className='lg:w-[40%] md:w-[40%] w-[100%] bg-white lg:rounded-tl-[50%] md:rounded-tl-[50%] lg:rounded-bl-[50%] rounded-tl-[50%] rounded-tr-[50%] text-right lg:rounded-tr-[20px] rounded-bl-[20px] rounded-br-[20px] p-6 flex justify-center'>
            <img src={bannerimage2} alt="dashboard" className='w-[100%] lg:w-[60%] md:w-[60%]' />
        </div>
    </div>
    );
};
